...
GLfloat square_vertices[] = {
	/* VERTICES(3)			NORMALS(3)			COORDINATE(2) */
...
int main() {
	...
	Texture* woodenBox				= NULL;
	Texture* woodenBoxSpecular		= NULL;
	...
	woodenBoxSpecular = new Texture();
	woodenBoxSpecular->load("wooden_box_specular.png");
	...
	while (!glfwWindowShouldClose(window)) 
	{
		...
		glBindTexture(GL_TEXTURE_2D, woodenBox->getID());

		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, woodenBoxSpecular->getID());
		...
		lightingShaderProgram->setInt("material.diffuse", 0); // assign texture unit 0
		lightingShaderProgram->setInt("material.specular", 1); // assign texture unit 0
	...
	woodenBox->deleteTexture();
	woodenBoxSpecular->deleteTexture();
